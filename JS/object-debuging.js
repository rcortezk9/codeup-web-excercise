/**
 * Created by renecortez on 4/14/17.
 */
...
console.log(pizza.crust); //completed
...
for (var index = 0; index < orders.length; index += 1) {  // it should always be <> when dealing with .length
